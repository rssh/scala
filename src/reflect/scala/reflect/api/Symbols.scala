...
trait Symbols { self: Universe =>
  ...
  /** The type of import symbol representing import statements */
  type ImportSymbol >: Null <: TermSymbol with ImportSymbolApi
  ...
  trait ImportSymbolApi extends TermSymbolApi { this: ImportSymbol =>
    ...
    final override def isImport = true
